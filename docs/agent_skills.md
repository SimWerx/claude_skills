...
> **Source**: Official Claude Documentation - https://docs.claude.com/en/docs/claude-code/agent-skills
> **Purpose**: Reference copy for staying aligned with Anthropic's official guidance
